    ...
    return (
        <Container component='main' className={classes.page}>
            ...
            <Box className={classes.style_start} p={2}>
                <Box width='33%'>姓名</Box>
                <Box width='33%'>邮箱</Box>
                <Box width='33%'><Link href='/'>修改密码</Link></Box>
            </Box>
            <Box borderBottom={5} width='100%' p={2} color="primary.main">
                <Typography>个人病例</Typography>
            </Box>
            <Box className={classes.style_row} p={2} >
                <Box bgcolor='gray' borderRadius='10px' maxheight='60px' alignItems='center'>
                <Toolbar className={classes.style_start} >
                    <Box className={classes.style_start}><Typography>我的病例</Typography></Box>
                ...
                <Box borderBottom={1} borderLeft={1} borderRight={1} height='20vh' maxHeight='30vh'>{!open?<TextField value={inputContent} onChange={handleInputChange} />:''}</Box>
            </Box>
